...
public class DDTweaks : BaseUnityPlugin
{
    ...
    private void Awake()
    {
        ...
        modSettings.buyJunk = Config.Bind("General", "Show own current stock when buying junk from bars", true,
            "Vanilla is false.  True will show you (have 25) of something when considering buying junk");
